...
{
    /// <inheritdoc />
    public partial class CatalogDbTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MotorPower = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SerialCode = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    MotorSerial = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_serial_numbers_product_variants_ProductVariantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_serial_numbers_ProductVariantId",
                table: "serial_numbers",
                column: "ProductVariantId");

            migrationBuilder.CreateIndex(
                name: "IX_serial_numbers_SerialCode",
                table: "serial_numbers",
                column: "SerialCode",
                unique: true);
        }
