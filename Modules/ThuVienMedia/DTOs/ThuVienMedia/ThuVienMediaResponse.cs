...
{
    public class ThuVienMediaResponse
    {
        ...
        public CMThuVienMediaResponse? CMThuVienMedia { get; set; }
        public ICollection<FileMediaResponse> Files { get; set; }
    = new List<FileMediaResponse>();
    }
}
